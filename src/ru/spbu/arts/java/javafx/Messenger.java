...
public class Messenger extends Application {
    ...
    private void addContacts() {
        surnamesInContacts.add("Мастер краб");
        surnamesInContacts.add("Большой краб");
        surnamesInContacts.add("Средний краб");
        surnamesInContacts.add("Малый краб");
    }
